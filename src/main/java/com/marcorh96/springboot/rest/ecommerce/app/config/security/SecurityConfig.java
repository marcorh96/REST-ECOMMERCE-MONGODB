...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable().authorizeHttpRequests(authConfig -> {
            authConfig.requestMatchers("/api/users/login").permitAll();
            authConfig.requestMatchers("/api/users/signin").permitAll();
            authConfig.requestMatchers("/api/users/upload/img/**").permitAll();
            authConfig.requestMatchers("/api/products/page/**").permitAll();
            authConfig.requestMatchers("/api/products/upload/img/**").permitAll();
